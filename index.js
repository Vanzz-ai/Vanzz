...
const vcard = 'BEGIN:VCARD\n' // ANAK ANJING MAU NGAPAIN ASU!?
            ...
            + 'VG:VANZZ\n' // NAMA OWNER BOT
            + 'ORG:Creator VANZZBOT;\n' // KASIH CREDITS GUA FADHIL GRAPHY SU!!!
            + 'TEL;type=CELL;type=VOICE;waid=6288221608614:+62 821-3248-6898 \n' // GANTI NOMOR LU
            + 'END:VCARD
prefix = '/'
blocked = []
...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6282132486898@s.whatsapp.net"] // GANTI NOMOR LU
			const adminbotnumber = ["6282132486898@s.whatsapp.net"] // GANTI NOMOR LU
			...
			case 'owner':
               ...
               case 'infogempa':
			    ...
			    case 'otagall':
					...
					mentions('╔══✪〘 Mention All 〙✪══'+teks+'╚═〘 KAZUTO BOT 〙', members_id, true)
					break
				case 'clearall':
					if (!isOwner) return reply('Kamu siapa?')
